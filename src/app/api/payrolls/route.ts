...
export async function GET(req: Request) {
    ...
    if (error) {
        ...
        return NextResponse.json({ error: getErrorMessage(error, 'Failed to load payrolls') }, { status: 500 });
    }
...
export async function POST(req: Request) {
    ...
    try {
        ...
        if (error) {
            ...
            return NextResponse.json({ error: getErrorMessage(error, 'Failed to save payroll') }, { status: 500 });
        }
...
export async function PATCH(req: Request) {
    ...
    try {
        ...
        if (error) {
            return NextResponse.json({ error: getErrorMessage(error, 'Failed to update') }, { status: 500 });
        }
...
export async function DELETE(req: Request) {
    ...
    if (error) {
        ...
        return NextResponse.json({ error: getErrorMessage(error, 'Failed to delete payroll') }, { status: 500 });
    }
