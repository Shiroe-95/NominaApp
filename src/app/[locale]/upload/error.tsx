...
export default function UploadError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center px-4">
      ...
      <h2 className="text-xl font-semibold text-white">Error al cargar la página de carga</h2>
      <p className="text-sm text-slate-400 max-w-md">
        Ocurrió un problema al preparar el pipeline de carga. Por favor intenta de nuevo.
      </p>
      <button
        onClick={reset}
