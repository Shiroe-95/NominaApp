...
const variantClasses: Record<string, string> = {
    ...
    primary: "bg-[#7C3AED] text-white shadow-[0_0_20px_rgba(124,58,237,0.3)] hover:shadow-[0_0_30px_rgba(124,58,237,0.5)] hover:-translate-y-0.5 active:scale-[0.98]",
    secondary: "bg-[#181b26] text-[#ccc3d8] hover:bg-[#1c1f2a] active:scale-[0.98]",
    destructive: "bg-[#E11D48] text-white shadow-[0_0_20px_rgba(225,29,72,0.3)] hover:shadow-[0_0_30px_rgba(225,29,72,0.5)] hover:-translate-y-0.5 active:scale-[0.98]",
    outline: "border border-white/10 bg-transparent text-[#ccc3d8] hover:bg-[#262a35] hover:text-white active:scale-[0.98]",
